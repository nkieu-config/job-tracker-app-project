...
const apps = [
  { id: "demo_app_1", company: "Acme Corp", role: "Senior Backend Engineer", status: "INTERVIEW", jd: seniorJd, deadline: "2026-06-20" },
  ...
  { id: "demo_app_4", company: "Hooli", role: "Frontend Engineer", status: "SAVED", jd: null, deadline: "2026-06-25" },
  { id: "demo_app_5", company: "Stark Industries", role: "DevOps Engineer", status: "REJECTED", jd: null, deadline: null },
  { id: "demo_app_6", company: "Wayne Enterprises", role: "Software Engineer (New Grad)", status: "APPLIED", jd: null, deadline: "2026-06-30" },
];
...
console.log(`Seeded demo account ${DEMO_EMAIL}: ${apps.length} applications + 1 resume.`);
await conn.dispose?.();
